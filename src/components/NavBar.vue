  ...
  >
    ...
    <div class="flex items-center gap-6">
      ...
      <div class="relative flex items-center">
        <div
          v-if="isSearchOpen"
          class="absolute right-0 flex items-center bg-stone-50 text-stone-900 rounded-full px-4 py-2 shadow-lg border border-stone-200 w-[200px] md:w-[300px] transition-all duration-300"
        >
          <input
            ref="searchInputRef"
            v-model="searchQuery"
